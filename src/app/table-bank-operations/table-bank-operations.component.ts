...
@Component({
  selector: 'app-table-bank-operations',
  templateUrl: './table-bank-operations.component.html',
  styleUrls: ['./table-bank-operations.component.css']
})
export class TableBankOperationsComponent implements OnInit {
